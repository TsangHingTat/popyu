                    ...
                    te = {
                        ...
                        methods: {
                            fetchLeaderboardData: function() {
                                var e = this;
                                ee.load("https://us-central1-popxi-f3a4d.cloudfunctions.net/leaderboard").then((function(t) {
                                ...
                                return Object(l.a)(regeneratorRuntime.mark((function t() {
                                    ...
                                    return regeneratorRuntime.wrap((function(t) {
                                        for (;;) switch (t.prev = t.next) {
                                            ...
                                            case 8:
                                                a = t.sent, n = "", e.token && (n = "&token=".concat(e.token)), oe.post("".concat("https://us-central1-popxi-f3a4d.cloudfunctions.net/stats", "?count=").concat(e.accumulator > 5e3 ? 5e3 : e.accumulator, "&captcha_token=").concat(a).concat(n)).then((function(t) {
